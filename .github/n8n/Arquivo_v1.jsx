                ...
                <div className="p-6">
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            <div><strong>Arquivo:</strong> <span className="text-gray-400">{workflow.fileName}</span></div>
                            <div><strong>Caminho:</strong> <span className="text-gray-400">/workflows/</span></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <button onClick={handleDownload} className="w-full sm:w-auto flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2">
                                📥
                                <span>Baixar JSON</span>
                            </button>
                            <button onClick={handleViewOnGitHub} className="w-full sm:w-auto flex-1 bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2">
...
export default function App() {
    ...
    return (
        <div className="bg-gray-900 min-h-screen text-white font-sans">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredWorkflows.map(workflow => (
                            ...
                            >
                                <h3 className="text-lg font-bold text-white mb-2 truncate" title={workflow.name}>{workflow.name}</h3>
                                <p className="text-gray-400 text-sm mb-4 truncate" title={workflow.fileName}>{workflow.fileName}</p>
            ...
            {/* O componente Modal é renderizado aqui */}
