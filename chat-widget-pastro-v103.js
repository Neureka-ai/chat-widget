...
const file = fileInput.files[0];
    ...
    if (file) {
        // Cria o bloco visual do arquivo
        ...
        // Insere o nome do arquivo no campo de texto (se quiser)
        ...
        removeBtn.addEventListener('click', () => {
            ...
            fileNameDisplay.innerHTML = ''; // Remove o bloco visual
            textarea.value = ''; // Opcional: limpa o campo de texto
        });
    }
});
