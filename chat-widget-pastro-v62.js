...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-header {
            ...
            background: var(--chat-color-surface); /* Mantém consistência visual */
        }
...
function adicionarCalendarioNaConversa() {
    ...
    iframeContainer.innerHTML = `
        <iframe 
            src="https://cal.com/thiagorspastro/60min?overlayCalendar=true" 
            width="80%" height="400" frameborder="0" 
            style="border-radius: 20px; margin-top: 80px;">
        </iframe>
    `;
