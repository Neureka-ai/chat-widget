...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget iframe {
            max-height: 400px; /* Altura máxima para o calendário */
        }
        ...
        .chat-assist-widget .chat-messages {
            ...
            flex-direction: column;
            gap: 12px;
            overflow-anchor: none; /* Previne o scroll automático quando o iframe é carregado */
        }
...
function adicionarCalendarioNaConversa() {
    ...
    iframeContainer.className = 'chat-bubble bot-bubble'; // Usa o mesmo estilo das mensagens do bot
    iframeContainer.style.padding = '0'; // Remove padding interno para o iframe
    iframeContainer.style.overflow = 'hidden'; // Garante que o iframe não vaze
    
    // Cria um wrapper para o iframe para melhor controle
    const iframeWrapper = document.createElement('div');
    iframeWrapper.style.position = 'relative';
    iframeWrapper.style.paddingBottom = '56.25%'; // Proporção 16:9 (ajuste conforme necessário)
    iframeWrapper.style.height = '0';
    iframeWrapper.style.overflow = 'hidden';
    
    const iframe = document.createElement('iframe');
    iframe.src = "https://cal.com/thiagorspastro/60min?overlayCalendar=true";
    ...
    // Adiciona um event listener para redimensionar o iframe quando necessário
