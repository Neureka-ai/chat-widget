...
.chat-assist-widget .chat-controls {
    ...
    function adicionarCalendarioNaConversa() {
        ...
        iframeContainer.className = 'mensagem-bot';
        iframeContainer.innerHTML = `
            <iframe 
                src="https://calendar.app.google/UbPuttmNCEaMfzkf9" 
        ...
        welcomeContainer.innerHTML = `
            ...
            <div class="message-content">
              <div class="chat-bubble bot-bubble">
                <p>Olá! 😊 Eu sou seu assistente virtual bilíngue de alemão. Confira o que posso fazer por você:<br>
                  1. Responder dúvidas sobre minha metodologia 🧠📘<br>
                  2. Agendar uma aula teste no calendário 📅📚<br>
    ...
    async function submitMessage(messageText) {
        ...
        try {
            ...
            const responseText = renderMarkdown(rawResponse);
