...
(function() {
    ...
    let currentLevel = '';
    let currentTopic = '';
    let currentUserId = null; // ALTERAÇÃO: Adicionado para guardar o ID do utilizador
    let currentUserEmail = null; // ALTERAÇÃO: Adicionado para guardar o e-mail do utilizador
    ...
    const startChat = () => {
        ...
        // ALTERAÇÃO: Captura o ID e o e-mail do utilizador
    ...
    const sendToN8n = async (payload) => {
        ...
        try {
            const response = await fetch(settings.webhook.url, {
                ...
                body: JSON.stringify({
                    userId: currentUserId, // ALTERAÇÃO: Envia o ID do utilizador
                    email: currentUserEmail, // ALTERAÇÃO: Envia o e-mail do utilizador
