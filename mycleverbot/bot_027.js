...
(function() {
    ...
    const handleTextInput = () => {
        ...
        const payload = {
            message: text,
            workflow: currentLevel || 'text_input',
            tema: text, 
            thread: conversationId
        };
        ...
        // A função handleAction não é ideal aqui, vamos chamar sendToN8n diretamente
        (async () => {
            isWaitingForResponse = true;
            sendButton.disabled = true;
            try {
