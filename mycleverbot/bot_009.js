...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .action-button {
            background: linear-gradient(135deg, #E91E63, #C2185B); /* COR DOS BOTÕES ALTERADA PARA ROSA ESCURO */
            color: white;
            border: none;
            padding: 12px 16px;
            border-radius: var(--chat-radius-md);
        ...
        .chat-assist-widget .action-button:hover {
            ...
            box-shadow: 0 4px 12px rgba(233, 30, 99, 0.3); /* SOMBRA DOS BOTÕES ALTERADA PARA ROSA */
        }
