...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-header {
            padding: 16px; /* Aumentado para acomodar o logo maior */
            display: flex;
            align-items: center;
            gap: 12px;
            background: #ffffff;
        ...
        .chat-assist-widget .chat-header-logo {
            height: 90px; /* LOGO CONSIDERAVELMENTE MAIOR */
            width: auto;
            object-fit: contain;
        }
        ...
        .chat-assist-widget .chat-header-slogan {
            font-size: 11px; /* FONTE DO SLOGAN DIMINUÍDA */
    ...
    const defaultSettings = {
        ...
        branding: {
            ...
            name: 'CorrectMe',
            slogan: 'Do erro à excelência, palavra por palavra.'
        },
    };
