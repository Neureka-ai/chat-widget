    ...
    const sendToN8nWorkflow = async (messageText, workflowType) => {
        ...
        try {
            ...
            botMessageContainer.innerHTML = `
                <img src="https://cdn-icons-png.flaticon.com/512/4140/4140048.png" class="message-icon" alt="CorrectMe Assistant">
    ...
    const submitMessage = async (messageText, skipUserMessage = false) => {
        ...
        if (!skipUserMessage) {
            ...
            userMessageContainer.innerHTML = `
                <img src="https://cdn-icons-png.flaticon.com/512/4140/4140057.png" class="message-icon" alt="Você">
                <div class="message-content">
