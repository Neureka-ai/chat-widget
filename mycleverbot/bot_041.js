...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        @media (max-width: 1023px) {
            ...
            .chat-assist-widget .chat-launcher {
                /* JS irá controlar top, left, transform */
                right: auto;
                bottom: auto;
                width: 48px;
                height: 48px;
        ...
        if (window.innerWidth < 1023) {
            ...
            if (header) {
                ...
                if (logo && logoutButton) {
                    ...
                    launchButton.style.transform = 'translate(-70%, -30%)';
                } else {
                    // Fallback se os elementos não forem encontrados
    ...
    // Um pequeno timeout para garantir que o header do dashboard já foi renderizado
