...
(function() {
    ...
    const submitPayloadToN8n = async (payload) => {
        ...
        try {
            ...
            // CORREÇÃO: Verifica se a resposta do n8n é um array e extrai o primeiro item.
            ...
            if (responseData && responseData.output) {
                try {
                    // Tenta analisar o conteúdo de "output" caso seja um JSON aninhado
                    ...
                    // Se não for um JSON aninhado, é o texto final
                    finalOutput = responseData.output;
                }
                addBotMessage(finalOutput);

            } else if (!responseData) {
                // Erro de comunicação já foi tratado na função sendToN8n
            } else {
