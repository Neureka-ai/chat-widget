...
async function submitMessage(messageText) {
    ...
    // 👇 1. MOSTRAR MENSAGEM DO USUÁRIO (com ícone à direita e timestamp)
    ...
    try {
        ...
        // 👇 3. REMOVER INDICADOR DE DIGITAÇÃO
        messagesContainer.removeChild(typingIndicator);
        
        // 👇 4. MOSTRAR RESPOSTA DO BOT (com ícone à esquerda e timestamp)
        ...
        // 👇 5. TRATAR ERRO (com ícone do bot)
        messagesContainer.removeChild(typingIndicator);
        ...
        errorMessage.innerHTML = `
            <img src="https://cdn-icons-png.flaticon.com/512/4712/4712035.png" class="message-icon" alt="Chatbot">
            <div class="message-content">
                <p>Sorry, I couldn't send your message. Please try again.</p>
                <span class="timestamp">${new Date().toLocaleString('pt-BR')}</span>
            </div>
        `;
