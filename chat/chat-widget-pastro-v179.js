...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-submit {
            ...
            width: 48px;
            height: 48px;
            background-color: var(--chat-color-light); /* Light blue, same as upload */
            color: var(--chat-color-text-light); /* Light gray icon color by default */
            border-radius: var(--chat-radius-md);
            border: none;
            cursor: pointer;
            transition: var(--chat-transition);
        ...
        .chat-assist-widget .chat-submit:hover {
            background-color: var(--chat-color-primary); /* Primary color on hover */
        ...
        .chat-assist-widget .chat-submit svg path {
