...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        /* Estilo para o botão de scroll up */
        .scroll-up-btn {
            position: absolute;
            right: 60px;
            bottom: 12px;
...
.chat-assist-widget .chat-controls {
    ...
    function disableActionButtons() {
        const buttonsToDisable = document.querySelectorAll('.action-button, .dynamic-button');
    ...
    function handleDoubtClick() {
        ...
        dynamicButtons.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                disableActionButtons(); // Desabilita todos os botões dinâmicos
                submitMessage(topic);
            });
        });
    }
    ...
    function startChat() {
        ...
        // Adiciona o botão de scroll up
        const scrollUpBtn = document.createElement('button');
        scrollUpBtn.className = 'scroll-up-btn';
        scrollUpBtn.title = 'Voltar ao topo';
        scrollUpBtn.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 15l-6-6-6 6"/>
            </svg>
        `;
        chatControls.appendChild(scrollUpBtn);

        // Evento para o botão de scroll up
