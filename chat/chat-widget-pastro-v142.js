...
(function() {
    ...
    const resetFileInput = () => {
        ...
        fileInput.nextElementSibling.style.backgroundColor = '';
    };
    ...
    // Start chat when the "Start Chatting" button is clicked
    chatWindow.querySelector('.chat-start-btn').addEventListener('click', startChat);
