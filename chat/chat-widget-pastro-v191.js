...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        /* === UPDATED SUBMIT BUTTON STYLES START === */
        ...
        /* === UPDATED SUBMIT BUTTON STYLES END === */
    ...
    const chatInterfaceHTML = `
        <div class="chat-body active">
            ...
            <!-- === UPDATED SUBMIT BUTTON HTML START === -->
            ...
            <!-- === UPDATED SUBMIT BUTTON HTML END === -->
            </div>
    ...
    chatWindow.innerHTML = headerHTML + chatInterfaceHTML.replace(/<br>/g, ''); // Clean up stray <br> tags
    ...
    const startChat = () => {
        ...
        welcomeContainer.innerHTML = \`
            ...
            <div class="message-content">
                <div class="chat-bubble bot-bubble">
                    <p>Olá! 😊 Eu sou seu assistente virtual especializado em energia solar. Confira o que posso fazer por você:<br><br>                    1. Responder dúvidas sobre energia solar ☀️<br><br>                    2. Agendar uma reunião no calendário 📅<br><br>                    3. Criar um chamado para falar com alguém 👨‍💼<br><br>                    4. Analisar sua conta de luz e estimar quanto você pode economizar usando painéis solares 💡💰<br><br>                    Do que você precisa?</p>
