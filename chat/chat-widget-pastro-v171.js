...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-submit {
            ...
            border: 2px dashed red; /* Para ver o espaço do botão */
        }
        ...
        .chat-assist-widget .chat-submit svg {
          width: 24px;
          height: 24px;
          fill: white !important; /* Força a cor branca */
          background: rgba(0,0,0,0.2); /* Para ver a área do SVG */
        }
            ...
            <div class="message-content">
                <div class="chat-bubble bot-bubble">
                    <iframe 
                        ...
                        width="450" height="1650" frameborder="0" 
