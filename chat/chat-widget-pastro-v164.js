...
<body>
    ...
    (function() {
        ...
        widgetStyles.textContent = `
            ...
            /* --- CORREÇÃO: Estilos do botão de envio movidos para cá --- */
        ...
        async function submitMessage(messageText, isInternal = false) {
            ...
            try {
                ...
                let processedResponse = renderMarkdown(rawResponse || "Recebido!");
        ...
        fileInput.addEventListener('change', () => {
            if (fileInput.files.length > 0) {
                // We don't have a dedicated display area, but we can focus the textarea
