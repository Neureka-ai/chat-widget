...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-submit {
          ...
          width: 48px;
          height: 48px;
          background-color: #f0f0f0;         /* cor de fundo visível */
          border-radius: 12px;
          border: none;                      /* remove borda padrão */
          outline: none;                     /* remove highlight laranja */
          cursor: pointer;
          flex-shrink: 0;
          transition: background-color 0.3s ease;
          color: #333;                       /* <- ESSENCIAL pro ícone aparecer */
        }
        
        .chat-assist-widget .chat-submit:hover {
          background-color: #007bff;         /* muda o fundo ao passar o mouse */
          color: white;                      /* muda a cor do ícone também */
        }
        
        .chat-assist-widget .chat-submit svg {
          width: 24px;
          height: 24px;
          display: block;                    /* garante que não herde display inline errado */
        }
