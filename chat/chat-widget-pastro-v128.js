                ...
                <div class="message-content">
                    <div class="chat-bubble bot-bubble">
                        ...
                        <div class="dynamic-buttons-container">
                            <button class="dynamic-button" data-topic="Energia solar - Materiais">Energia solar - Materiais</button>
                            <button class="dynamic-button" data-topic="Energia solar - Funcionamento">Energia solar - Funcionamento</button>
							<button class="dynamic-button" data-topic="Energia solar - Instalacao">Energia solar - Instalacao</button>
                            <button class="dynamic-button" data-topic="Eletromobilidade - o que é">Eletromobilidade - o que e</button>
							 <button class="dynamic-button" data-topic="Eletromobilidade - Materiais">Eletromobilidade - Materiais</button>
                            <button class="dynamic-button" data-topic="Eletromobilidade - Carregamento com energia solar">Eletromobilidade - Carregamento com energia solar/</button>
                        </div>
                    </div>
                    <span class="timestamp">${new Date().toLocaleString('pt-BR')}</span>
                </div>
