...
<body>
    ...
    <!-- Simulação da configuração do widget -->
    <script>
        window.ChatWidgetConfig = {
            webhook: {
                url: 'https://webhook.site/a9e14c1a-7b4f-4a8f-8c3c-74a4a1b02b0f', // URL de teste para ver as requisições
                route: 'main'
            },
            branding: {
    ...
    (function() {
        ...
        async function submitMessage(messageText, isInternal = false) {
            ...
            try {
                ...
                let processedResponse = renderMarkdown(rawResponse || "Sua mensagem foi recebida!");
                ...
                errorMessageContainer.innerHTML = `
                    ...
                    <div class="message-content">
                        <div class="chat-bubble bot-bubble">
                            <p>Desculpe, ocorreu um erro. O assistente pode estar offline. Tente novamente mais tarde.</p>
                        </div>
                        <span class="timestamp">${new Date().toLocaleString('pt-BR')}</span>
                    </div>
                `;
