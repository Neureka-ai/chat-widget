...
(function() {
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .chat-window {
            ...
            z-index: 1000;
            width: 380px;
            height: 913px; /* MODIFICADO: Aumentado em 25% de 730px */
        ...
        /* MODIFICAÇÃO: Estilos para o contêiner do calendário */
        .chat-assist-widget .calendar-message .message-content {
            max-width: 100%;
            flex: 1;
        }

        .chat-assist-widget .calendar-message .chat-bubble {
            max-width: 100%;
            padding: 0;
            background: transparent;
            border: none;
    ...
    const addCalendarToChat = () => {
        ...
        // MODIFICAÇÃO: Adicionada classe 'calendar-message' para aplicar estilos específicos
        iframeContainer.className = 'message-container bot-message calendar-message';
