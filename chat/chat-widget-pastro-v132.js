                ...
                <div class="message-content">
                    <div class="chat-bubble bot-bubble">
                        ...
                        <div class="dynamic-buttons-container">
                          ...
                          <button class="dynamic-button" data-topic="O que">O que é eletromobilidade</button>
                          ...
                          <button class="dynamic-button" data-topic="Lucrar com Eletromobilidade">Lucrar com Eletromobilidade</button>
                        </div>
                    </div>
                    <span class="timestamp">${new Date().toLocaleString('pt-BR')}</span>
                </div>
