...
(function() {
    ...
    fontElement.href = '[https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap](https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap)';
    ...
    widgetStyles.textContent = `
        ...
        .chat-assist-widget .scroll-to-top-button {
            background: linear-gradient(135deg, var(--chat-color-primary) 0%, var(--chat-color-secondary) 100%);
            color: white;
            border: none;
            ...
            box-shadow: var(--chat-shadow-sm);
            transition: var(--chat-transition);
            margin-left: 5px; /* Space from textarea */
            opacity: 0; /* Hidden by default */
            visibility: hidden;
            position: absolute; /* Position it absolutely within chat-controls */
            right: 12px; /* Adjust based on send button */
            bottom: 60px; /* Position above the input area */
            z-index: 10;
        }

        .chat-assist-widget .scroll-to-top-button.visible {
            opacity: 1;
            visibility: visible;
        }

        .chat-assist-widget .scroll-to-top-button:hover {
            transform: scale(1.1);
            box-shadow: var(--chat-shadow-md);
        }

        .chat-assist-widget .scroll-to-top-button svg {
            width: 20px;
            height: 20px;
        }
...
.chat-assist-widget .chat-controls {
    ...
    position: relative; /* Changed to relative for absolute positioning of scroll button */
    bottom: 0;
    background: white;
    z-index: 10;
}
    ...
    const defaultSettings = {
        ...
        branding: {
            ...
            poweredBy: {
                ...
                link: '[https://neureka-ai.com](https://neureka-ai.com)'
            }
        },
        style: {
    ...
    // Create chat interface with file upload and new scroll-to-top button
            ...
            <div class="chat-controls">
                <div class="file-upload-container">
                    <label for="chat-file-upload" class="file-upload-label">
                        <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <button class="scroll-to-top-button">
                    <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up">
    ...
    function adicionarCalendarioNaConversa() {
        ...
        iframeContainer.innerHTML = `
            <img src="[https://cdn-icons-png.flaticon.com/512/4712/4712035.png](https://cdn-icons-png.flaticon.com/512/4712/4712035.png)" class="message-icon" alt="Chatbot">
            <div class="message-content">
                <div class="chat-bubble bot-bubble">
                    <iframe 
                        src="[https://calendar.app.google/tps9rXCFtW3VUoiBA](https://calendar.app.google/tps9rXCFtW3VUoiBA)" 
    ...
    const scrollToTopButton = chatWindow.querySelector('.scroll-to-top-button'); // Get the new button
    ...
    function startChat() {
        ...
        function handleDoubtClick() {
                ...
                <div class="message-content">
                    <div class="chat-bubble bot-bubble">
                        ...
                        <div class="dynamic-buttons-container">
                            ...
                            <button class="dynamic-button" data-topic="O que é eletro mobilidade?">O que é eletro mobilidade?</button>
                            <button class="dynamic-button" data-topic="Como Recarrega">Estação de Recarga</button>
                            <button class="dynamic-button" data-topic="Recarga Solar">Recarga Solar</button>
                            <button class="dynamic-button" data-topic="Benefícios Eletro mobilidade">Benefícios Eletro mobilidade</button>
                            <button class="dynamic-button" data-topic="Futuro Eletro mobilidade">Futuro Eletro mobilidade</button>
                            <button class="dynamic-button" data-topic="Carregamento é Seguro?">Carregamento é Seguro?</button>
                            <button class="dynamic-button" data-topic="Tecnologias que Impulsionam">Tecnologias que Impulsionam</button>
                            <button class="dynamic-button" data-topic="Mercado está Crescendo?">Mercado está Crescendo?</button>
                            <button class="dynamic-button" data-topic="Tendências Globais">Tendências Globais</button>
                            <button class="dynamic-button" data-topic="Lucrar com Eletro mobilidade">Lucrar com Eletro mobilidade</button>
                        </div>
                    </div>
                    <span class="timestamp">${new Date().toLocaleString('pt-BR')}</span>
                </div>
            ...
            dynamicButtons.forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    // No longer disabling dynamic buttons after one is clicked
                });
            });
        }
        ...
        buttons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                // No longer disabling initial action buttons
    ...
    async function submitMessage(messageText, isInternal = false) {
        ...
        <div class="message-content">
            <div class="chat-bubble user-bubble">
                ...
                <img src="[https://cdn-icons-png.flaticon.com/512/4202/4202836.png](https://cdn-icons-png.flaticon.com/512/4202/4202836.png)" class="message-icon" alt="Usuário">
        `;
    ...
    messagesContainer.addEventListener('scroll', () => {
        if (messagesContainer.scrollTop > 100) { // Show button if scrolled down more than 100px
