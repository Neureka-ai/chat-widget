            ...
            <div class="chat-controls">
                ...
                <button class="chat-reset-buttons-btn" title="Reativar opções iniciais">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M9.09 18.09a3 3 0 0 1 0-5.18l2.71-2.71a3 3 0 0 1 4.24 0L18 10"></path>
                        <path d="M14.91 5.91a3 3 0 0 1 0 5.18l-2.71 2.71a3 3 0 0 1-4.24 0L6 14"></path>
    ...
    function attachActionButtonsListeners(container) {
        ...
        buttons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                disableActionButtons(container); // Disable buttons in this specific container
