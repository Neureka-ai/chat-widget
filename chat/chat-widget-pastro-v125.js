...
function startChat() {
   ...
   // Add styles for the action buttons
        ...
        function enableActionButtons() {
            const buttonsToEnable = welcomeContainer.querySelectorAll('.action-button');
            buttonsToEnable.forEach(btn => {
                btn.disabled = false;
                btn.style.opacity = '0.9'; // Reset to original opacity
                btn.style.cursor = 'pointer';
            });
            // Also remove any dynamic buttons if present
